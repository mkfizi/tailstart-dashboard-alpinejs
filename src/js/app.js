/**
 * --------------------------------------------------------------------------
 * Tailstart - Dashboard (AlpineJS) v0.1.0: app.js
 * Licensed under MIT (https://github.com/mkfizi/tailstart-dashboard-alpinejs/blob/main/LICENSE)
 * --------------------------------------------------------------------------
 */
...
(function () {
    ...
    app.name = 'Tailstart - Dashboard (AlpineJS)';
    app.version = '0.1.0';
